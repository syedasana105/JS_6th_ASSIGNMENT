...
var d = add(a, b);
document.write("The addition is: " + d + "<br>");
...
num = +prompt("Enter any number to get its square");
var squ = square(num);
document.write("The square of " + num + " is: " + squ + "<br>");
...
end = +prompt("Enter ending value");
var count = counting(start, end);
...
var f = calArea(3, 4);
document.write("Area of rectangle using values: " + f + "<br>")
...
function specifiedCharacter(strng, letter) {
    var letterCheck = 0;
    for (var place = 0; place < strng.length; place++) {
        if (strng.charAt(place) == letter) {
            letterCheck += 1;
        }
    }
    return letterCheck;
}
var strng = prompt("Enter any string.");
var letter = prompt("write any one letter");
document.write("Specfied character is: " + specifiedCharacter(strng, letter) + "<br>");
...
document.write("The circumference of circle is: " + calcCircumference(radius) + "<br>");
...
var radius = +prompt("Enter radius");
document.write("The Area of circle is: " + calcArea(radius) + "<br>");
